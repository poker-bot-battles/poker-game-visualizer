...
export class TestPokerGameService {
  ...
  getTestdataFlop(): Step {
    ...
    return {
      stepId: 6,
      timeconstant: STAGE_CHANGE_TIMECONSTANT,
      playerStates: states,
      boardState: boardState,
    };
  }
